...
public class MainActivity extends SupportActivity implements OnChangeActivityStatusListener, NetBroadcastReceiver.NetEvevt {
    ...
    public void onClick() {
        if (getTopFragment().getClass() == MainFragment.class) {
            ((MainFragment) getTopFragment()).onBackPressedSupport();
        } else {
            if (getTopFragment() instanceof OnFragmentHandleActivityClickListener) {
                OnFragmentHandleActivityClickListener mListener = (OnFragmentHandleActivityClickListener) getTopFragment();
                mListener.onTbLeftClick();
            } else {
                pop();
            }
        }
